...
func _apply_export_overrides() -> void:
    ...
    # var stylebox: StyleBox = load("res://addons/dialogic/Modules/DefaultLayoutParts/Layer_SpeakerPortraitTextbox/default_stylebox.tres")
    # panel.add_theme_stylebox_override(&'panel', stylebox)
    # portrait_panel.add_theme_stylebox_override(&'panel', stylebox)
